  ...
  return (
    <main>
      ...
      <div className="md:hidden flex justify-center py-6">
        <ul className="mx-10">
          <li className="my-5"><Card width="350" height="400" title="WARCORD" image="/warcord.webp" desc="An NPM Library created to be an alternative option to the WarGaming API." tec="TYPESCRIPT" link="https://github.com/Warcord/WarCord-Lib" /></li>
          <li className="my-5"><Card width="350" height="400" title="Red Dragon Bot" image="/reddragon.webp" desc="My first project, which was not finished, was a Discord bot." tec="JAVASCRIPT" /></li>
          <li className="my-5"><Card width="350" height="400" title="Flaming Eyes" image="/flamingeyes.webp" desc="It was my first 'public' project. A server on discord with the premise of being a bot store." tec={["JAVASCRIPT", "TYPESCRIPT", "MONGODB"]} /></li>
      ...
      <div className="w-full md:flex hidden justify-center mx-auto mb-10">
        <ul>
